...
Gracias a mi segunda casa, Suecia, por haberme enseñado a ser independiente y a valorar aún más lo que se tiene, por darme la posibilidad de conocer a gente tan maravillosa que, en poco tiempo, me ha ayudado a crecer como persona y, por haberme enseñado grandes lecciones. Aunque estéis lejos siempre os llevo conmigo.
...
Hace un par de años, en el Grupo de Sistemas y Comunicaciones (Gsyc) de la Universidad Rey Juan Carlos (URJC), brotó la iniciativa de crear una herramienta - Dr. Scratch - destinada a analizar proyectos Scratch y a aportar realimentación sobre los diferentes aspectos del Pensamiento Computacional para potenciar, de esta forma, el aprendizaje de la programación.\newline

Tras el gran éxito que esto supuso, mi tutor en este proyecto, Gregorio Robles, tuvo la gran idea de extender este prototipo de herramienta educativa a otros lenguajes de programación. El primer candidato para implementar dicha idea fue Pencil Code, lenguaje que sigue la linea de Scratch en cuanto a la programación con bloques.
Pencil Code soporta CoffeeScript como lenguaje principal y, además, ofrece la posibilidad de escribir tu propio código. Se trata de un lenguaje de programación de propósito general por lo que el análisis de los proyectos Pencil Code será más complicado que el de los proyectos Scratch.\newline
 
La decisión de realizar la aplicación para este lenguaje de programación surgió gracias a Gregorio Robles tras ponerse en contacto con el creador de Pencil Code, David Bau, a quien le propuso la idea. David Bau nos remitió a Yana Malysheva, responsable de Pencil Code en Boston durante este año académico, con quien hemos trabajado, recibiendo retroalimentación y distintos puntos de vista, durante el desarrollo de este proyecto.\newline

Para analizar un proyecto realizado con Pencil Code es necesario inspeccionar su código. Dr. Pencilcode guarda el código del programa en un JSON y analiza su contenido. La tarea de analizar toda la información del fichero JSON se atribuye al software \texttt{Coffee-mastery.py}, plugin que tuvo que desarrollarse en paralelo junto con Dr. Pencilcode para poder realizar dicho análisis.\newline
...
\begin{itemize}
  ...
  \item \textbf{Introducción:} En este apartado, entre otras cosas, se enmarca y contextualiza el proyecto. Por otro lado, se da una explicación de como surgió Dr. Pencilcode y se indica la planificación temporal del mismo.
    
  \item \textbf{Objetivos:}  Capítulo en el que se determinan los objetivos generales y específicos que fueron fijados durante el desarrollo del proyecto.
...
\item Mejorar la página mostrada tras el análisis de un proyecto, incluir más dinamismo y elementos visuales con el objetivo de conseguir mayor inteligibilidad por parte del usuario.
...
Al igual que la mayoría de proyectos, el desarrollo de Pencil Code ha supuesto numerosas horas de trabajo. Se trata de un proyecto desarrollado únicamente por mi junto con el soporte de mi tutor, Gregorio Robles, y la retroalimentación de Yana Malysheva. Este proyecto abarca una duración aproximada de dos años (cursos académicos) pudiéndo divirse en dos fases principales.\newline
...
Fue en esta fase donde conseguimos ponernos en contacto con Yana Malysheva con quien intercambiamos diferentes ideas y opiniones via e-mail. A partir de aquí, comencé con el desarrollo completo de la web manteniéndola activa en el servidor.
Los objetivos que se establecieron en esta fase son, prácticamente, todos los mencionados en el apartado de \textit{Objetivos específicos}.
...
\item \textbf{Cuerpo (opcional)}: contiene cualquier tipo de datos. Los cuerpos de las peticiones llevan información al servidor, mientras que los de las respuestas llevan la información de vuelta al cliente. A diferencia de la linea inicial y la cabecera, el cuerpo puede incluir datos binarios (audio, imágenes, vídeo, etc) además de texto.

\end{itemize}

En las solicitudes HTTP se pueden incluir una serie de métodos ya predefinidos. Los métodos se encuentran en la linea de inicio e indican al servidor la acción que debe realizar sobre el recurso indicado. Entre los más utilizados en este proyecto se encuentran:
...
JavaScript, conocido comúnmente como JS, es un lenguaje de programación interpretado orientado a objetos que se utiliza principalmente para añadir dinamismo a las páginas web. A pesar de su similitud con el nombre del lenguaje de programación Java, no debe confundirse con éste ya que ambos tienen finalidades muy diferentes.\newline
...
Como ya se ha mencionado en el capítulo 3 de la memoria, Dr. Pencilcode es una plataforma desarrollada con Django. En la \textit{Figura ~\ref{figura:folder}}, se puede observar el árbol de ficheros y directorios que componen la aplicación.
...
Lo primero que se observa nada más acceder a al sitio web es el diseño mostrado en la \textit{Figura ~\ref{fig:mainpage}}. En esta sección se hace una breve presentación de la herramienta y se muestra el cuadro en el que se introduce la URL para dar paso al análisis del proyecto.
...
La rúbrica inicial es muy diferente a la que ésta disponible actualmente en la web. A lo largo de mi año de trabajo, se han ido realizando diferentes modificaciones hasta llegar al método de evaluación que estábamos buscando. Se pueden distinguir tres fases principales en el desarrollo de la rúbrica:
...
\item Este método, realmente, no evaluaba los proyectos, si no que mostraba el porcentaje de bloques que se habían utilizado. Desde mi punto de vista, esta rúbrica no impulsaba tanto el deseo de mejorar y aprender a programar como lo podía hacer la rúbrica de la fase 1 (con niveles y puntuaciones).
...
Como se puede leer en el correo \textit{Apéndice~\ref{app:emails}}, había preocupación en las palabras y expresiones utilizadas en la primera versión del formulario. Al tratarse de una encuesta enfocada especialmente a niños, Yana sugirió modificar las preguntas y adaptar las palabras con el fin de que fueran comprensibles para los más pequeños.
...
Para poder demostrar que, realmente, ha habido modificaciones. He realizado una comparación entre el repositiorio de la última versión de Dr. Pencilcode y el repositorio master de Dr. Scratch.
...
\item \textbf{Añadir nuevas funcionalidades y secciones a la página web}. En este objetivo no se especificó un número concreto de adiciones. Las novedades que se llevaron a cabo para alcanzar dicho objetivo fueron: la implementación de un formulario, el diseño de 9 páginas de ayuda, los bonus, cambio de apariencia del dashboard incluyendo 3 nuevas secciones.  
...
\item \textbf{Servidor Apache y maquinas virtuales.} Nunca antes había subido una web a un servido por lo que, al igual que con Django, tuve que aprender de forma autodidacta a instalar y configurar el servidor web Apache.
