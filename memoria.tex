...
Finalmente, para motivar aún más a los niños, se decidió añadir \emph{bonus}. Por el momento hay 4 tipos de bonus disponibles:
...
\item \textbf{Tabla de puntuaciones}: Con la introducción de los \emph{bonus}, se añadió una nueva fila a la tabla de puntuaciones en la que estos quedaban representados con estrellas; se rellenan tantas estrellas como bonus se consigan.
...
Como se puede observar, la puntuación del programa ha pasado de 4 a 13. Además de mejorar las puntuaciones específicas de tres categorías, se han conseguido Bonus por diversidad, complejidad y repetición de bloque. Aun así, el usuario podría seguir mejorando el código añadiendo bloques de Text y Sonido como se indica en la sección \textit{What can you improve?}.
